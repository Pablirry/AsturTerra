...
public class ValorarRuta extends JFrame {
    ...
    public ValorarRuta(String ruta) {
        this.ruta = ruta;
        ...
        lblTitulo = new JLabel("Valorar " + ruta);
        ...
        ValorarRutaController valorarRutaController = new ValorarRutaController(this, ruta);
